...
export const metadata = { title: "Mes progrès — Najaح" };
...
export default async function ProgressPage() {
  ...
  return (
    <StudentShell active="progress" childName={child?.full_name} childGrade={child?.grade}>
      <h1 className="text-2xl font-bold text-fg mb-6">Mes progrès</h1>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-surface border border-line rounded-card p-4 text-center">
          ...
          <div className="text-xs text-fg-soft mt-1">Quiz</div>
        </div>
        <div className="bg-surface border border-line rounded-card p-4 text-center">
          <div className="text-2xl font-bold text-fg">—</div>
          <div className="text-xs text-fg-soft mt-1">Moyenne</div>
        </div>
        <div className="bg-surface border border-line rounded-card p-4 text-center">
          <div className="text-2xl font-bold text-fg">0</div>
          <div className="text-xs text-fg-soft mt-1">XP</div>
        </div>
      </div>

      <div className="bg-surface border border-line rounded-card p-6 mb-4">
        <h2 className="font-semibold text-fg mb-3">Évolution</h2>
        ...
        <p className="text-xs text-fg-faint text-center mt-3">
          Ton graphique apparaît dès le premier quiz.
        </p>
      </div>
    </StudentShell>
  );
