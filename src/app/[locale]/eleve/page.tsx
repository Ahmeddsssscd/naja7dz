  ...
  return (
    <StudentShell active="home" childName={child?.full_name ?? tStudent("default_name")} childGrade={child?.grade} childStreak={streak.current}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3 mb-8">
        ...
        />
        {/* 2b. Programme de la semaine — universal */}
        <BigTile
          href="/eleve/programme"
          icon={CalendarTile}
          title="Mon programme"
          subtitle="Organise ta semaine"
          color="bg-purple-50 dark:bg-purple-950/30 text-fg border-purple-200 dark:border-purple-900"
        />
...
function CalendarTile({ size = 24, className }: { size?: number; className?: string }) {
  return (
