...
const TILES = [
  ...
  { href: "/petits/monde-reel/wilayas", emoji: "🇩🇿", title: "Les 58 wilayas", color: "bg-amber-100 dark:bg-amber-950/30 text-amber-900 dark:text-amber-100" },
  { href: "/petits/monde-reel/adab", emoji: "🤲", title: "Bonnes manières", color: "bg-emerald-100 dark:bg-emerald-950/30 text-emerald-900 dark:text-emerald-100" },
];
  ...
  return (
    <div className="min-h-screen bg-cream pb-12">
      <header className="px-5 py-4 flex items-center justify-between bg-white border-b border-pale-blue">
        ...
        <h1 className="font-bold text-navy">Le monde réel</h1>
        <div className="w-10" />
      </header>

      <main className="max-w-md mx-auto px-5 py-6">
        <p className="text-fg-soft text-center mb-6">Apprends des choses utiles pour la vraie vie.</p>
