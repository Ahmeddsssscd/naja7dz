  ...
  return (
    <div className="min-h-screen bg-cream dark:bg-surface-2 flex flex-col">
      ...
      <main className="flex-1 px-5 py-6 max-w-md md:max-w-3xl mx-auto w-full">
        {/* Recipe card */}
        <div className="bg-surface border-4 border-amber-400 rounded-3xl p-5 md:p-6 mb-5 shadow-card text-center">
          ...
          {choices.map((n) => {
            ...
            return (
              <button key={n}
                ...
                className={`bg-surface rounded-2xl border-4 py-5 px-3 text-2xl font-bold text-navy transition active:scale-95 ${
