...
export function GeographyGame({ wilayas }: { wilayas: Wilaya[] }) {
  ...
  if (!target) {
    return <div className="min-h-screen bg-cream dark:bg-surface-2 flex items-center justify-center text-fg-soft">Pas de données wilayas — applique migration 5.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-cream dark:bg-surface-2 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-5 gap-6">
        <div className="bg-surface border-2 border-navy rounded-3xl p-6 max-w-sm text-center shadow-card">
