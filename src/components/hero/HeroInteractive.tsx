...
const SUBJECTS = [
  {
    id: 'maths', emoji: '📐', label: 'Maths', label_ar: 'الرياضيات',
  ...
  {
    id: 'arabe', emoji: '📖', label: 'Arabe', label_ar: 'العربية',
  ...
  {
    id: 'francais', emoji: '✒️', label: 'Français', label_ar: 'الفرنسية',
  ...
  {
    id: 'sciences', emoji: '🔬', label: 'Sciences', label_ar: 'العلوم',
      ...
      <div aria-hidden className="bg-surface rounded-2xl p-6 shadow-card-hover border border-line max-w-md w-full mx-auto md:ms-auto select-none">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="flex items-center gap-1.5 bg-surface-2 border border-line rounded-btn px-3 py-1.5 text-sm">
            <span>🔥</span><span className="font-bold text-fg">12</span>
            <span className="text-fg-soft text-xs">jours</span>
          </div>
          <div className="flex items-center gap-1.5 bg-surface-2 border border-line rounded-btn px-3 py-1.5 text-sm">
            <span>⭐</span><span className="font-bold text-fg">3</span>
